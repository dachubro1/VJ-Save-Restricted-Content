...
async def send_start(client: Client, message: Message):
    buttons = [[
        InlineKeyboardButton("❣️ Developer", url = "https://t.me/polihudgaa_admin")
    ],[
        InlineKeyboardButton('🌐 Website', url='https://polihudgaa.uk'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/polihudgaa')
	]]
